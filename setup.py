...
setup(
    ...
    package_dir={"qspace_direction": "src/qspace_direction", "qspace_direction.sampling": "src/qspace_direction/sampling", "qspace_direction.io_util": "src/qspace_direction/lib"},
    install_requires=[
        "numpy >= 1.19.5",
        "scipy >= 1.10.0",
        "gurobipy == 10.0.3",
