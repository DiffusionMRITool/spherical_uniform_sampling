...
Usage:
    generation_geem.py [-v | -q] --number=NUMBER --output=OUTPUT [--asym] [--max_iter ITER] [--initialization INIT] [--fslgrad]
...
from spherical_uniform_sampling.sampling.geem import compute_weights
from spherical_uniform_sampling.sampling.geem import optimize as geem_optimize
